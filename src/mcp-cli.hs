...
showHelp = do
  ...
  putStrLn ""
  putStrLn "EXAMPLE mcp-cli.json (simple format):"
  putStrLn "    {"
  putStrLn "      \"commands\": ["
  putStrLn "        \"ls -l\","
  putStrLn "        \"date\","
  ...
  putStrLn "    }"
  putStrLn ""
  putStrLn "EXAMPLE mcp-cli.json (with custom names):"
  putStrLn "    {"
  putStrLn "      \"commands\": ["
  putStrLn "        { \"name\": \"list-files\","
  putStrLn "          \"command\": \"ls -l\""
  putStrLn "        },"
  putStrLn "        { \"name\": \"git-status\""
  putStrLn "          \"command\": \"git status\""
  putStrLn "        },"
  putStrLn "        \"pwd\""
  putStrLn "      ]"
  putStrLn "    }"
